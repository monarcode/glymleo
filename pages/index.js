  ...
  const testimonials = [
    {
      ...
      name: 'Ms Teggy Sam',
      message:
        'Glym leo autos was responsive,extremely knowledgeable not only about my newly acquired Red 2016 MERCEDES Benz GLE 350 which I got in May,but walking me through the whole process, My satisfaction was un-paralleled going above and beyond in every Aspect.',
      img: teggy,
    },
    {
      id: 2,
      name: 'Mrs Helen',
      message:
        'Glym Leo Autos has been my car plug since my second car in the year 2016. His cars are top quality and I haven’t had any reason to complain about the cars I have purchased from him over the years.',
      img: helen,
    },
    {
      id: 3,
      name: 'Bobby Udo',
      message:
        'I bought a black 2016 Toyota Avalon from  Glym Leo Autos in the year 2019 and ever since that first transaction he has turned to a friend because of his great customer service and the good car he sold to me.',
      img: bobby,
    },
    {
      id: 4,
      name: 'Emmanuel',
      message:
        'My name is Emmanuel and honestly, buying a car from Glym Leo Autos was scary at first because I got to know him through his JIji advertisement but after giving him a try and purchasing a range rover from him, I can legitly say I made the right choice purchasing the range rover from him.',
      img: emmanuel,
    },
  ];
